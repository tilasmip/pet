...
from main.models import Breed, Category,ProductSales, ProductWhislist,AnimalWhislist, Product
...
class UpdateBreedSerializer(serializers.ModelSerializer):
    ...
    def validate(self,attrs):
        ...
        if dup_Breed is not None:
            raise serializers.ValidationError({'msg':'Breed with the name already exists.'})
