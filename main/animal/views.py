...
class UpdateAnimalView(APIView):
    ...
    def put(self,request,pk,format = None):
        ...
        serializer = UpdateAnimalSerializer(instance = instance, data = request.data, context = {'id':pk}, partial = True)
        serializer.is_valid(raise_exception=True)
        serializer.save()
...
class DeleteAnimalView(APIView):
    ...
    def delete(self,request,pk,format = None):
        serializer = DeleteAnimalSerializer(data = request.data, context = {'id':pk})
        serializer.is_valid(raise_exception=True)
